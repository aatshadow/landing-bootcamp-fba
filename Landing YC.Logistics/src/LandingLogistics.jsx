...
const STRINGS = {
  es: {
    ...
    cta: { title: '¿Listo para enviar desde China?', sub: 'Cotización sin compromiso. Sin costes ocultos. Soporte real desde Shenzhen.', primary: 'Calcular envío', secondary: 'Contactar con agente' },
  ...
  en: {
    ...
    cta: { title: 'Ready to ship from China?', sub: 'No-commitment quote. No hidden fees. Real support from Shenzhen.', primary: 'Calculate shipment', secondary: 'Contact agent' },
